...
|---|---|---|---|
| 2026-09-13 | Phase 4.3 | Added persisted review queue contracts and API actions with reviewer identity, rationale, policy version, optimistic `review_version`, safe list/detail projections, approve/reject/request-changes handling, and redacted `review_recorded` audit events | Complete Phase 4.4 restart and race-safety gates |
